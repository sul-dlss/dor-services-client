...
RSpec.describe Dor::Services::Client::UserVersion do
  ...
  describe '#find' do
    ...
    let(:body) { build(:dro, id: 'druid:bc123df4567') }
    let(:status) { 200 }
    let(:version) { 2 }

    before do
      stub_request(:get, "https://dor-services.example.com/v1/objects/#{druid}/user_versions/#{version}")
  ...
  describe '#solr' do
    ...
    before do
      stub_request(:get, "https://dor-services.example.com/v1/objects/druid:bc123df4567/user_versions/2/solr?validate=#{validate}")
