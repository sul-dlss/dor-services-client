...
RSpec.describe Dor::Services::Client::ObjectWorkflows do
  ...
  describe '#list' do
    subject(:workflows) { client.list }

    before do
      stub_request(:get, 'https://dor-services.example.com/v1/objects/druid:mw971zk1113/workflows')
    ...
    context 'when API request succeeds' do
      ...
      it 'returns the workflows' do
        expect(workflows).to be_a(Dor::Services::Response::Workflows)
      end
    end
